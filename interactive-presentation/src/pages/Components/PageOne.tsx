      ...
      <Grid h="100vh" templateColumns="auto" alignItems="center">
        <Grid templateColumns="1fr 1.25fr" gap="10rem">
          ...
          <Box>
            ...
            <Text mt=".5rem">
              Een component is een functie die een stukje HTML teruggeeft. De
              syntax wijkt niet veel af van een standaard HTML element.
            </Text>
            ...
            <Box mt="3rem">
              ...
              <Text>
                ...
                component welke een of meerdere onderliggende componenten heeft.
                De andere soort is een component welke geen onderliggende
                componenten heeft.
              </Text>
