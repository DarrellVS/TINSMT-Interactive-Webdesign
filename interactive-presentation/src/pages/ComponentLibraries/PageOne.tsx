import { Box, Text, Grid, Heading, Divider } from "@chakra-ui/react";
      ...
      <Grid h="100vh" templateColumns="auto" alignItems="center">
        <Grid templateColumns="1fr 1.25fr" gap="10rem">
          ...
          <Box>
            ...
            <Text mt=".5rem">
              Een van de dingen die React zo populair maakt is de grote
              hoeveelheid component libraries die beschikbaar zijn.
            </Text>

            <Text mt=".5rem" mb="1.5rem">
              Deze component libraries bevatten vaak al veel van de componenten
              die je nodig hebt om een website te bouwen.
            </Text>
            ...
            <Box mt="2rem">
              ...
              <Text>
                Hier is een component library gebruikt om de styling te
                verbeteren, thanks Chakra UI!
              </Text>
            </Box>
          </Box>
        </Grid>
